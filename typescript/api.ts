...
export const SafeCheckoutApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiUsersIdoffersPost: async (id: number, ulid: string, offerSoloWrite: OfferSoloWrite, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const SafeCheckoutApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiUsersIdoffersPost(id: number, ulid: string, offerSoloWrite: OfferSoloWrite, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OfferPostCreationRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiUsersIdoffersPost(id, ulid, offerSoloWrite, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const SafeCheckoutApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiUsersIdoffersPost(id: number, ulid: string, offerSoloWrite: OfferSoloWrite, options?: RawAxiosRequestConfig): AxiosPromise<OfferPostCreationRead> {
            return localVarFp.apiUsersIdoffersPost(id, ulid, offerSoloWrite, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SafeCheckoutApi extends BaseAPI {
     ...
     * @memberof SafeCheckoutApi
     */
    public apiUsersIdoffersPost(id: number, ulid: string, offerSoloWrite: OfferSoloWrite, options?: RawAxiosRequestConfig) {
        return SafeCheckoutApiFp(this.configuration).apiUsersIdoffersPost(id, ulid, offerSoloWrite, options).then((request) => request(this.axios, this.basePath));
    }
}
