...
class TestBankAccountUserRead(unittest.TestCase):
    """BankAccountUserRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountUserRead:
        """Test BankAccountUserRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountUserRead`
        """
        model = BankAccountUserRead()
        if include_optional:
            return BankAccountUserRead(
                iban = '',
                bic = '',
    ...
    def testBankAccountUserRead(self):
        """Test BankAccountUserRead"""
