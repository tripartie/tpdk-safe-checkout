...
class TestWalletUserRead(unittest.TestCase):
    """WalletUserRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WalletUserRead:
        """Test WalletUserRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalletUserRead`
        """
        model = WalletUserRead()
        if include_optional:
            return WalletUserRead(
                balance = 1.337,
                currency = '',
