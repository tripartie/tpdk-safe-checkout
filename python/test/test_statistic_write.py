...
class TestStatisticWrite(unittest.TestCase):
    """StatisticWrite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatisticWrite:
        """Test StatisticWrite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatisticWrite`
        """
        model = StatisticWrite()
        if include_optional:
            return StatisticWrite(
                request = [FINALIZED_CASHOUT_AMOUNT, FINALIZED_CASHOUT_COUNT],
