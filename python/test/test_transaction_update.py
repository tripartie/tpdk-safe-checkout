    ...
    def make_instance(self, include_optional) -> TransactionUpdate:
        ...
        if include_optional:
            return TransactionUpdate(
                ...
                buyer_review = '01234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556575859',
                buyer_rating = 0,
                seller_review = '01234567891011121314151617181920212223242526272829303132333435363738394041424344454647484950515253545556575859',
                seller_rating = 0,
