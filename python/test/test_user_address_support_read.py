...
class TestUserAddressSupportRead(unittest.TestCase):
    """UserAddressSupportRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserAddressSupportRead:
        """Test UserAddressSupportRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserAddressSupportRead`
        """
        model = UserAddressSupportRead()
        if include_optional:
            return UserAddressSupportRead(
    ...
    def testUserAddressSupportRead(self):
        """Test UserAddressSupportRead"""
