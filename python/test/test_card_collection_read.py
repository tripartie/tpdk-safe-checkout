...
class TestCardCollectionRead(unittest.TestCase):
    """CardCollectionRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardCollectionRead:
        """Test CardCollectionRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardCollectionRead`
        """
        model = CardCollectionRead()
        if include_optional:
            return CardCollectionRead(
    ...
    def testCardCollectionRead(self):
        """Test CardCollectionRead"""
