            ...
            return OfferCollectionRead(
                ...
                organization = tpdk_safe_checkout.models.offer_organization_collection_read.Offer-Organization-CollectionRead(
                    ...
                    logo = tpdk_safe_checkout.models.offer_media_collection_read.Offer-Media-CollectionRead(
                        ...
                        thumbnail_url = 'https://cdn.tripartie.app/b15e64db-fbd2-442b-afee-69ee45e2959b.jpg', ), 
                    primary_color = '', ),
                seller = tpdk_safe_checkout.models.offer_persona_collection_read.Offer-Persona-CollectionRead(
                    id = 56, 
                    first_name = 'John', 
                    last_name = 'Doe', 
                    registered = True, 
                    verified = True, ),
                preset_buyer = tpdk_safe_checkout.models.offer_persona_collection_read.Offer-Persona-CollectionRead(
                    id = 56, 
                    first_name = 'John', 
                    last_name = 'Doe', 
                    registered = True, 
