...
class TestAddressUserRead(unittest.TestCase):
    """AddressUserRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressUserRead:
        """Test AddressUserRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressUserRead`
        """
        model = AddressUserRead()
        if include_optional:
            return AddressUserRead(
