...
class TestCashoutCashOutRead(unittest.TestCase):
    """CashoutCashOutRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CashoutCashOutRead:
        """Test CashoutCashOutRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashoutCashOutRead`
        """
        model = CashoutCashOutRead()
        if include_optional:
    ...
    def testCashoutCashOutRead(self):
        """Test CashoutCashOutRead"""
