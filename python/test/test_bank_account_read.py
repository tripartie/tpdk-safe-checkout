...
class TestBankAccountRead(unittest.TestCase):
    """BankAccountRead unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountRead:
        """Test BankAccountRead
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountRead`
        """
        model = BankAccountRead()
        if include_optional:
