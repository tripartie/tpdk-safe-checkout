...
class SafeCheckoutApi:
    ...
    @validate_call
    def api_transactions_ulidevaluations_post(
        self,
        ...
        **Only authenticated** complainant and seller **CAN** issue an evaluation **WHEN** the transaction reached a final state.
        ...
        _param = self._api_transactions_ulidevaluations_post_serialize(
            ulid=ulid,
    ...
    @validate_call
    def api_transactions_ulidevaluations_post_with_http_info(
        self,
        ulid: Annotated[StrictStr, Field(description="Evaluation identifier")],
        evaluation_write: Annotated[EvaluationWrite, Field(description="The new Evaluation resource")],
        _request_timeout: Union[
    ...
    @validate_call
    def api_transactions_ulidevaluations_post_without_preload_content(
        self,
        ulid: Annotated[StrictStr, Field(description="Evaluation identifier")],
        evaluation_write: Annotated[EvaluationWrite, Field(description="The new Evaluation resource")],
        _request_timeout: Union[
    ...
    def _api_transactions_ulidevaluations_post_serialize(
        self,
        ulid,
        evaluation_write,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/transactions/{ulid}/evaluations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
