...
class TransactionOfferCollectionRead(BaseModel):
    ...
    organization: Optional[TransactionOrganizationCollectionRead] = None
    ...
    medias: List[TransactionMediaCollectionRead]
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    __properties: ClassVar[List[str]] = ["ulid", "status", "publicUrl", "organization", "seller", "presetBuyer", "nature", "title", "unitPrice", "minNegotiableUnitPrice", "allowToNegotiateUnitPrice", "currencyCode", "itemCount", "condition", "medias", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": TransactionOrganizationCollectionRead.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            ...
            "medias": [TransactionMediaCollectionRead.from_dict(_item) for _item in obj["medias"]] if obj.get("medias") is not None else None,
