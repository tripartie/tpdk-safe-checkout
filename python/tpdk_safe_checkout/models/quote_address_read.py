...
class QuoteAddressRead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["countryCode", "zipCode", "cityName", "firstLine", "secondLine", "buildingName", "buildingFloor", "gateOrPortalOrInboxCode", "createdAt", "updatedAt", "formattedAddress"]
