...
class PersonaRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "gender", "dateOfBirth", "language", "email", "mobilePhoneNumber", "address", "metadata", "createdAt", "updatedAt", "offerCount", "purchaseCount", "registered", "verified"]
