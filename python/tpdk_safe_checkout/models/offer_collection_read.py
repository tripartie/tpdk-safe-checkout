...
class OfferCollectionRead(BaseModel):
    ...
    preset_buyer: Optional[OfferPersonaCollectionRead] = Field(default=None, alias="presetBuyer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seller": OfferPersonaCollectionRead.from_dict(obj["seller"]) if obj.get("seller") is not None else None,
            "presetBuyer": OfferPersonaCollectionRead.from_dict(obj["presetBuyer"]) if obj.get("presetBuyer") is not None else None,
