...
class OfferCollectionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ulid", "status", "publicUrl", "seller", "presetBuyer", "nature", "title", "unitPrice", "currencyCode", "itemCount", "condition", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "createdAt", "updatedAt", "iri"]
