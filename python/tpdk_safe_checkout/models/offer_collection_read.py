...
class OfferCollectionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ulid", "status", "publicUrl", "url", "seller", "presetBuyer", "nature", "title", "unitPrice", "minNegotiableUnitPrice", "allowToNegotiateUnitPrice", "currencyCode", "itemCount", "condition", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "createdAt", "updatedAt", "iri"]
