...
class TransactionRead(BaseModel):
    ...
    buyer_review: Optional[StrictStr] = Field(default=None, alias="buyerReview")
    buyer_rating: Optional[StrictInt] = Field(default=None, alias="buyerRating")
    seller_review: Optional[StrictStr] = Field(default=None, alias="sellerReview")
    seller_rating: Optional[StrictInt] = Field(default=None, alias="sellerRating")
    ...
    __properties: ClassVar[List[str]] = ["ulid", "offer", "quote", "buyerMessage", "buyer", "status", "supplementalFees", "card", "escrow", "remotePreAuthorizationId", "remotePayInId", "balanceToRefund", "feesToRefund", "forceRefundShipping", "buyerReview", "buyerRating", "sellerReview", "sellerRating", "handOverCode", "parcels", "createdAt", "updatedAt", "metadata", "providerName", "providerCreatedAt", "providerUpdatedAt", "total", "totalCharged", "totalFees", "awaitedParty", "statusExpiration", "review", "rating", "processorStatus"]
