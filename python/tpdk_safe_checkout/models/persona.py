...
class Persona(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "organization", "firstName", "lastName", "gender", "dateOfBirth", "language", "email", "mobilePhoneNumber", "address", "metadata", "offers", "purchases", "views", "createdAt", "updatedAt", "ownedBy", "offerCount", "purchaseCount"]
