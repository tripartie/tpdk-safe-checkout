...
class CardCollectionRead(BaseModel):
    """
    ...
    metadata: Optional[List[CardMetadataCollectionRead]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "primaryAccountNumber", "expireAt", "currency", "countryCode", "brand", "createdAt", "updatedAt", "metadata", "providerName", "providerCreatedAt", "providerUpdatedAt", "iri", "processorStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": [CardMetadataCollectionRead.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
