...
class TransactionQuoteCollectionRead(BaseModel):
    ...
    third_party_recipient_address: Optional[Dict[str, Any]] = Field(default=None, alias="thirdPartyRecipientAddress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thirdPartyRecipientAddress": obj.get("thirdPartyRecipientAddress"),
