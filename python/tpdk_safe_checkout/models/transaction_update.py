...
class TransactionUpdate(BaseModel):
    ...
    buyer_review: Optional[Annotated[str, Field(min_length=60, strict=True, max_length=10000)]] = Field(default=None, alias="buyerReview")
    buyer_rating: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=None, alias="buyerRating")
    seller_review: Optional[Annotated[str, Field(min_length=60, strict=True, max_length=10000)]] = Field(default=None, alias="sellerReview")
    seller_rating: Optional[Annotated[int, Field(le=10, strict=True, ge=0)]] = Field(default=None, alias="sellerRating")
    ...
    __properties: ClassVar[List[str]] = ["status", "supplementalFees", "balanceToRefund", "feesToRefund", "forceRefundShipping", "buyerReview", "buyerRating", "sellerReview", "sellerRating", "handOverCodeConfirmation", "updatedAt", "review", "rating"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if buyer_review (nullable) is None
        # and model_fields_set contains the field
        if self.buyer_review is None and "buyer_review" in self.model_fields_set:
            _dict['buyerReview'] = None

        # set to None if buyer_rating (nullable) is None
        # and model_fields_set contains the field
        if self.buyer_rating is None and "buyer_rating" in self.model_fields_set:
            _dict['buyerRating'] = None

        # set to None if seller_review (nullable) is None
        # and model_fields_set contains the field
        if self.seller_review is None and "seller_review" in self.model_fields_set:
            _dict['sellerReview'] = None

        # set to None if seller_rating (nullable) is None
        # and model_fields_set contains the field
        if self.seller_rating is None and "seller_rating" in self.model_fields_set:
            _dict['sellerRating'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "buyerReview": obj.get("buyerReview"),
            "buyerRating": obj.get("buyerRating"),
            "sellerReview": obj.get("sellerReview"),
            "sellerRating": obj.get("sellerRating"),
