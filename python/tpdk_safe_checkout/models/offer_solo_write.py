...
class OfferSoloWrite(BaseModel):
    ...
    weight_in_gram: Annotated[int, Field(le=10000, strict=True, ge=500)] = Field(description="Accepted values between 500g (0.5kg) and 10,000g (10kg).", alias="weightInGram")
