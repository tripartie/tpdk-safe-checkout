...
class UserWalletAuthenticatedRead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["balance", "currency", "createdAt", "updatedAt", "providerName", "providerCreatedAt", "providerUpdatedAt", "processorStatus"]
