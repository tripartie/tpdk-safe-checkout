...
class UserCardAuthenticatedRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["primaryAccountNumber", "expireAt", "currency", "countryCode", "ephemeral", "createdAt", "updatedAt", "providerName", "providerCreatedAt", "providerUpdatedAt", "processorStatus"]
