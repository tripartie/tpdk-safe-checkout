...
class UserCardAuthenticatedRead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "primaryAccountNumber", "expireAt", "currency", "countryCode", "brand", "ephemeral", "createdAt", "updatedAt", "providerName", "providerCreatedAt", "providerUpdatedAt", "iri", "processorStatus"]
