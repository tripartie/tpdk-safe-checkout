...
class TransactionQuoteRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ulid", "shippingCarrier", "pickupCode", "quantityToBeAcquired", "attemptUnitPrice", "currency", "originalUnitPrice", "transactionFees", "shippingFees", "createdAt", "expireAt", "iri", "unitPrice", "price", "buyerTotal", "sellerTotal"]
