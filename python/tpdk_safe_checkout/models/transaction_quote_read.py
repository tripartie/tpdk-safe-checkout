...
class TransactionQuoteRead(BaseModel):
    ...
    third_party_recipient_address: Optional[TransactionAddressRead] = Field(default=None, alias="thirdPartyRecipientAddress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thirdPartyRecipientAddress": TransactionAddressRead.from_dict(obj["thirdPartyRecipientAddress"]) if obj.get("thirdPartyRecipientAddress") is not None else None,
