...
class ApiClientRead(BaseModel):
    ...
    def scopes_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['PERSONA_READ', 'PERSONA_WRITE', 'OFFER_READ', 'OFFER_WRITE', 'ORGANIZATION_READ']):
                raise ValueError("each list item must be one of ('PERSONA_READ', 'PERSONA_WRITE', 'OFFER_READ', 'OFFER_WRITE', 'ORGANIZATION_READ')")
        return value
