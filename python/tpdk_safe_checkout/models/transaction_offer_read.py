...
class TransactionOfferRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ulid", "status", "publicUrl", "redirectUrl", "seller", "presetBuyer", "nature", "title", "description", "unitPrice", "currencyCode", "itemCount", "condition", "weightInGram", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "eanCode", "canBeSoldSeparately", "metadata", "medias", "createdAt", "updatedAt"]
