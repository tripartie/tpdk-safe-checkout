...
class TransactionParcelRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["carrier", "identifier", "price", "currency", "status", "labelPublicUrl", "createdAt", "updatedAt"]

    @field_validator('carrier')
    def carrier_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SwissPost', 'MondialRelay', 'Colissimo']):
            raise ValueError("must be one of enum values ('SwissPost', 'MondialRelay', 'Colissimo')")
        return value
