...
class ProofOfIdentityCollectionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "type", "originalFilename", "extension", "createdAt", "updatedAt", "providerName", "providerCreatedAt", "providerUpdatedAt", "processorStatus"]
