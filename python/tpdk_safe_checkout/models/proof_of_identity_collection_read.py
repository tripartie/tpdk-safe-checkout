...
class ProofOfIdentityCollectionRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "originalFilename", "extension", "createdAt", "updatedAt", "providerName", "providerCreatedAt", "providerUpdatedAt", "processorStatus"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['drafted', 'uploaded', 'submitted', 'accepted', 'refused']):
            raise ValueError("must be one of enum values ('drafted', 'uploaded', 'submitted', 'accepted', 'refused')")
        return value
