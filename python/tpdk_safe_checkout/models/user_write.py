...
class UserWrite(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["captcha", "firstName", "lastName", "publicName", "roleInCompany", "birthday", "email", "plainPassword", "intlPhoneNumber", "originCountry", "homeCountry", "preferredLanguage", "consentMailAds"]
