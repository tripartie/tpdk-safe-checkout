...
class OfferIndependentWrite(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["publicUrl", "redirectUrl", "seller", "presetBuyer", "nature", "title", "description", "unitPrice", "currencyCode", "itemCount", "condition", "weightInGram", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "eanCode", "canBeSoldSeparately", "metadata"]
