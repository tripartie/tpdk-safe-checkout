...
class TransactionPersonaRead(BaseModel):
    """
    ...
    address: Optional[TransactionAddressRead] = None
    registered: Optional[StrictBool] = Field(default=None, description="Determine if the Persona have a Tripartie account")
    verified: Optional[StrictBool] = Field(default=None, description="Determine if the Persona have a VERIFIED Tripartie account")
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "language", "email", "mobilePhoneNumber", "address", "registered", "verified"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": TransactionAddressRead.from_dict(obj["address"]) if obj.get("address") is not None else None,
