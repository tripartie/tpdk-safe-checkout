...
class UserWalletCollectionRead(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["balance", "currency", "createdAt", "updatedAt", "externalId", "providerName", "providerCreatedAt", "providerUpdatedAt", "processorStatus"]
