...
class QuoteWrite(BaseModel):
    ...
    third_party_recipient_address: Optional[QuoteAddressWrite] = Field(default=None, alias="thirdPartyRecipientAddress")
    __properties: ClassVar[List[str]] = ["captcha", "offer", "shippingCarrier", "pickupCode", "quantityToBeAcquired", "attemptUnitPrice", "thirdPartyRecipientFirstName", "thirdPartyRecipientLastName", "thirdPartyRecipientAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thirdPartyRecipientAddress": QuoteAddressWrite.from_dict(obj["thirdPartyRecipientAddress"]) if obj.get("thirdPartyRecipientAddress") is not None else None
        })
        return _obj
