...
class OfferOrganizationCollectionRead(BaseModel):
    """
    
    """ # noqa: E501
    name: Optional[StrictStr] = None
    website_url: Optional[StrictStr] = Field(default=None, alias="websiteUrl")
    icon: Optional[OfferMediaCollectionRead] = None
    logo: Optional[OfferMediaCollectionRead] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": OfferMediaCollectionRead.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": OfferMediaCollectionRead.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
