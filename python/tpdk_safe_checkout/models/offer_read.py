...
class OfferRead(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ulid", "status", "publicUrl", "redirectUrl", "url", "organization", "seller", "presetBuyer", "nature", "title", "unitPrice", "currencyCode", "itemCount", "condition", "weightInGram", "shippingAllowed", "handDeliveryAllowed", "shippingCarriers", "eanCode", "canBeSoldSeparately", "medias", "createdAt", "updatedAt", "iri"]
