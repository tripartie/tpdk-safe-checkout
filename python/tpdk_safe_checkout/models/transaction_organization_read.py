...
class TransactionOrganizationRead(BaseModel):
    """
    
    """ # noqa: E501
    name: Optional[StrictStr] = None
    website_url: Optional[StrictStr] = Field(default=None, alias="websiteUrl")
    icon: Optional[TransactionMediaRead] = None
    logo: Optional[TransactionMediaRead] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon": TransactionMediaRead.from_dict(obj["icon"]) if obj.get("icon") is not None else None,
            "logo": TransactionMediaRead.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
