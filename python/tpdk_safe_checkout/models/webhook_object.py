...
WEBHOOKOBJECT_ANY_OF_SCHEMAS = ["OfferRead", "PersonaRead"]
...
class WebhookObject(BaseModel):
    ...
    # data type: OfferRead
    anyof_schema_1_validator: Optional[OfferRead] = None
    # data type: PersonaRead
    anyof_schema_2_validator: Optional[PersonaRead] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[OfferRead, PersonaRead]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "OfferRead", "PersonaRead" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WebhookObject with anyOf schemas: OfferRead, PersonaRead. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WebhookObject with anyOf schemas: OfferRead, PersonaRead. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], OfferRead, PersonaRead]]:
