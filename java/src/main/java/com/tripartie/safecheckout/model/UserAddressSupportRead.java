...
public class UserAddressSupportRead {
  ...
  public UserAddressSupportRead companyName(String companyName) {
  ...
  public UserAddressSupportRead countryCode(String countryCode) {
  ...
  public UserAddressSupportRead zipCode(String zipCode) {
  ...
  public UserAddressSupportRead cityName(String cityName) {
  ...
  public UserAddressSupportRead firstLine(String firstLine) {
  ...
  public UserAddressSupportRead secondLine(String secondLine) {
  ...
  public UserAddressSupportRead buildingName(String buildingName) {
  ...
  public UserAddressSupportRead buildingFloor(String buildingFloor) {
  ...
  public UserAddressSupportRead gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class UserAddressSupportRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserAddressSupportRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAddressSupportRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAddressSupportRead is not found in the empty JSON string", UserAddressSupportRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAddressSupportRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAddressSupportRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAddressSupportRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAddressSupportRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAddressSupportRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAddressSupportRead.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAddressSupportRead>() {
           @Override
           public void write(JsonWriter out, UserAddressSupportRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAddressSupportRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserAddressSupportRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserAddressSupportRead
   * @throws IOException if the JSON string is invalid with respect to UserAddressSupportRead
   */
  public static UserAddressSupportRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAddressSupportRead.class);
  }

  /**
   * Convert an instance of UserAddressSupportRead to an JSON string
   *
   * @return JSON string
   */
