...
public class UserUserRead {
  ...
  private AddressUserRead mainAddress;
  ...
  public UserUserRead mainAddress(AddressUserRead mainAddress) {
   ...
   */
  @javax.annotation.Nullable
  public AddressUserRead getMainAddress() {
    return mainAddress;
  }

  public void setMainAddress(AddressUserRead mainAddress) {
    this.mainAddress = mainAddress;
  }
  ...
  public UserUserRead timeZoneOffset(Integer timeZoneOffset) {
  ...
  public UserUserRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public UserUserRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("mainAddress") != null && !jsonObj.get("mainAddress").isJsonNull()) {
        AddressUserRead.validateJsonElement(jsonObj.get("mainAddress"));
      }
