...
public class TransactionWalletRead {
  ...
  public TransactionWalletRead balance(Float balance) {
  ...
  public TransactionWalletRead currency(String currency) {
  ...
  public TransactionWalletRead updatedAt(OffsetDateTime updatedAt) {
  ...
  public TransactionWalletRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public TransactionWalletRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : TransactionWalletRead.openapiRequiredFields) {
