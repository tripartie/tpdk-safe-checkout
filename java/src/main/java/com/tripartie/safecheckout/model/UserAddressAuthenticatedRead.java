...
public class UserAddressAuthenticatedRead {
  ...
  public UserAddressAuthenticatedRead() {
  }
  ...
  public UserAddressAuthenticatedRead companyName(String companyName) {
  ...
  public UserAddressAuthenticatedRead countryCode(String countryCode) {
  ...
  public UserAddressAuthenticatedRead zipCode(String zipCode) {
  ...
  public UserAddressAuthenticatedRead cityName(String cityName) {
  ...
  public UserAddressAuthenticatedRead firstLine(String firstLine) {
  ...
  public UserAddressAuthenticatedRead secondLine(String secondLine) {
  ...
  public UserAddressAuthenticatedRead buildingName(String buildingName) {
  ...
  public UserAddressAuthenticatedRead buildingFloor(String buildingFloor) {
  ...
  public UserAddressAuthenticatedRead gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class UserAddressAuthenticatedRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserAddressAuthenticatedRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAddressAuthenticatedRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAddressAuthenticatedRead is not found in the empty JSON string", UserAddressAuthenticatedRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAddressAuthenticatedRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAddressAuthenticatedRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAddressAuthenticatedRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAddressAuthenticatedRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAddressAuthenticatedRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAddressAuthenticatedRead.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAddressAuthenticatedRead>() {
           @Override
           public void write(JsonWriter out, UserAddressAuthenticatedRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAddressAuthenticatedRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserAddressAuthenticatedRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserAddressAuthenticatedRead
   * @throws IOException if the JSON string is invalid with respect to UserAddressAuthenticatedRead
   */
  public static UserAddressAuthenticatedRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAddressAuthenticatedRead.class);
  }

  /**
   * Convert an instance of UserAddressAuthenticatedRead to an JSON string
   *
   * @return JSON string
   */
