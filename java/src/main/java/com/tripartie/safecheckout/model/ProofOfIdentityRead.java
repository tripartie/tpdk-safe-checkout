...
public class ProofOfIdentityRead {
  ...
  public ProofOfIdentityRead status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ProofOfIdentityRead type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ProofOfIdentityRead originalFilename(String originalFilename) {
  ...
  public ProofOfIdentityRead extension(String extension) {
  ...
  public ProofOfIdentityRead createdAt(OffsetDateTime createdAt) {
  ...
  public ProofOfIdentityRead updatedAt(OffsetDateTime updatedAt) {
  ...
  public ProofOfIdentityRead providerName(String providerName) {
  ...
  public ProofOfIdentityRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public ProofOfIdentityRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
  ...
  public String toString() {
    ...
    sb.append("class ProofOfIdentityRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProofOfIdentityRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProofOfIdentityRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProofOfIdentityRead is not found in the empty JSON string", ProofOfIdentityRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProofOfIdentityRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProofOfIdentityRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProofOfIdentityRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProofOfIdentityRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProofOfIdentityRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProofOfIdentityRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProofOfIdentityRead.class));

       return (TypeAdapter<T>) new TypeAdapter<ProofOfIdentityRead>() {
           @Override
           public void write(JsonWriter out, ProofOfIdentityRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProofOfIdentityRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProofOfIdentityRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProofOfIdentityRead
   * @throws IOException if the JSON string is invalid with respect to ProofOfIdentityRead
   */
  public static ProofOfIdentityRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProofOfIdentityRead.class);
  }

  /**
   * Convert an instance of ProofOfIdentityRead to an JSON string
   *
   * @return JSON string
   */
