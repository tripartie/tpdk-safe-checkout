...
public class UserWalletSupportRead {
  ...
  public UserWalletSupportRead currency(String currency) {
  ...
  public UserWalletSupportRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public UserWalletSupportRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
