...
public class TransactionUpdate {
  ...
  public static final String SERIALIZED_NAME_BUYER_REVIEW = "buyerReview";
  @SerializedName(SERIALIZED_NAME_BUYER_REVIEW)
  private String buyerReview;

  public static final String SERIALIZED_NAME_BUYER_RATING = "buyerRating";
  @SerializedName(SERIALIZED_NAME_BUYER_RATING)
  private Integer buyerRating;

  public static final String SERIALIZED_NAME_SELLER_REVIEW = "sellerReview";
  @SerializedName(SERIALIZED_NAME_SELLER_REVIEW)
  ...
  public TransactionUpdate buyerReview(String buyerReview) {
  ...
  public TransactionUpdate buyerRating(Integer buyerRating) {
  ...
  public TransactionUpdate sellerReview(String sellerReview) {
  ...
  public TransactionUpdate sellerRating(Integer sellerRating) {
  ...
  public String toString() {
    ...
    sb.append("    buyerReview: ").append(toIndentedString(buyerReview)).append("\n");
    sb.append("    buyerRating: ").append(toIndentedString(buyerRating)).append("\n");
    sb.append("    sellerReview: ").append(toIndentedString(sellerReview)).append("\n");
  ...
  static {
    ...
    openapiFields.add("buyerReview");
    openapiFields.add("buyerRating");
    openapiFields.add("sellerReview");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("buyerReview") != null && !jsonObj.get("buyerReview").isJsonNull()) && !jsonObj.get("buyerReview").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `buyerReview` to be a primitive type in the JSON string but got `%s`", jsonObj.get("buyerReview").toString()));
      }
      if ((jsonObj.get("sellerReview") != null && !jsonObj.get("sellerReview").isJsonNull()) && !jsonObj.get("sellerReview").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sellerReview` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sellerReview").toString()));
      }
