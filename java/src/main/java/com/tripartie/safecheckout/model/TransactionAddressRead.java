...
public class TransactionAddressRead {
  ...
  public TransactionAddressRead countryCode(String countryCode) {
  ...
  public TransactionAddressRead zipCode(String zipCode) {
  ...
  public TransactionAddressRead cityName(String cityName) {
  ...
  public TransactionAddressRead firstLine(String firstLine) {
  ...
  public TransactionAddressRead secondLine(String secondLine) {
  ...
  public TransactionAddressRead buildingName(String buildingName) {
  ...
  public TransactionAddressRead buildingFloor(String buildingFloor) {
  ...
  public TransactionAddressRead gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class TransactionAddressRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactionAddressRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionAddressRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionAddressRead is not found in the empty JSON string", TransactionAddressRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionAddressRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionAddressRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionAddressRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionAddressRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionAddressRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionAddressRead.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionAddressRead>() {
           @Override
           public void write(JsonWriter out, TransactionAddressRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionAddressRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransactionAddressRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransactionAddressRead
   * @throws IOException if the JSON string is invalid with respect to TransactionAddressRead
   */
  public static TransactionAddressRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionAddressRead.class);
  }

  /**
   * Convert an instance of TransactionAddressRead to an JSON string
   *
   * @return JSON string
   */
