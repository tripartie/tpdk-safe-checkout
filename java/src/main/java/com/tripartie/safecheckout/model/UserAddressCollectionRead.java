...
public class UserAddressCollectionRead {
  ...
  public UserAddressCollectionRead() {
  }
  ...
  public UserAddressCollectionRead companyName(String companyName) {
  ...
  public UserAddressCollectionRead countryCode(String countryCode) {
  ...
  public UserAddressCollectionRead zipCode(String zipCode) {
  ...
  public UserAddressCollectionRead cityName(String cityName) {
  ...
  public UserAddressCollectionRead firstLine(String firstLine) {
  ...
  public UserAddressCollectionRead secondLine(String secondLine) {
  ...
  public UserAddressCollectionRead buildingName(String buildingName) {
  ...
  public UserAddressCollectionRead buildingFloor(String buildingFloor) {
  ...
  public UserAddressCollectionRead gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class UserAddressCollectionRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserAddressCollectionRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserAddressCollectionRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserAddressCollectionRead is not found in the empty JSON string", UserAddressCollectionRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserAddressCollectionRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserAddressCollectionRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserAddressCollectionRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserAddressCollectionRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserAddressCollectionRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserAddressCollectionRead.class));

       return (TypeAdapter<T>) new TypeAdapter<UserAddressCollectionRead>() {
           @Override
           public void write(JsonWriter out, UserAddressCollectionRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserAddressCollectionRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserAddressCollectionRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserAddressCollectionRead
   * @throws IOException if the JSON string is invalid with respect to UserAddressCollectionRead
   */
  public static UserAddressCollectionRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserAddressCollectionRead.class);
  }

  /**
   * Convert an instance of UserAddressCollectionRead to an JSON string
   *
   * @return JSON string
   */
