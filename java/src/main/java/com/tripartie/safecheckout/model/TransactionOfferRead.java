...
public class TransactionOfferRead {
  ...
  private TransactionOrganizationRead organization;
  ...
  private List<TransactionMediaRead> medias = new ArrayList<>();
  ...
  public TransactionOfferRead organization(TransactionOrganizationRead organization) {
   ...
   */
  @javax.annotation.Nullable
  public TransactionOrganizationRead getOrganization() {
    return organization;
  }

  public void setOrganization(TransactionOrganizationRead organization) {
    this.organization = organization;
  }
  ...
  public TransactionOfferRead medias(List<TransactionMediaRead> medias) {
    this.medias = medias;
    return this;
  }

  public TransactionOfferRead addMediasItem(TransactionMediaRead mediasItem) {
    if (this.medias == null) {
   ...
   */
  @javax.annotation.Nonnull
  public List<TransactionMediaRead> getMedias() {
    return medias;
  }

  public void setMedias(List<TransactionMediaRead> medias) {
    this.medias = medias;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("organization") != null && !jsonObj.get("organization").isJsonNull()) {
        TransactionOrganizationRead.validateJsonElement(jsonObj.get("organization"));
      }
      ...
      for (int i = 0; i < jsonArraymedias.size(); i++) {
        TransactionMediaRead.validateJsonElement(jsonArraymedias.get(i));
      };
  }
