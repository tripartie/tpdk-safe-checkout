...
public class CardRead {
  ...
  public CardRead brand(BrandEnum brand) {
    this.brand = brand;
    return this;
  }
  ...
  public CardRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public CardRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
