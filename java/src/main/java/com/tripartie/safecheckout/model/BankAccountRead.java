...
public class BankAccountRead {
  ...
  public BankAccountRead providerName(String providerName) {
  ...
  public BankAccountRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public BankAccountRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
  ...
  public String toString() {
    ...
    sb.append("class BankAccountRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankAccountRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankAccountRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BankAccountRead is not found in the empty JSON string", BankAccountRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankAccountRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankAccountRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BankAccountRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BankAccountRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BankAccountRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BankAccountRead.class));

       return (TypeAdapter<T>) new TypeAdapter<BankAccountRead>() {
           @Override
           public void write(JsonWriter out, BankAccountRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BankAccountRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BankAccountRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BankAccountRead
   * @throws IOException if the JSON string is invalid with respect to BankAccountRead
   */
  public static BankAccountRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BankAccountRead.class);
  }

  /**
   * Convert an instance of BankAccountRead to an JSON string
   *
   * @return JSON string
   */
