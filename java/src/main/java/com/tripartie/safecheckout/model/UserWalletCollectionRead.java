...
public class UserWalletCollectionRead {
  ...
  public UserWalletCollectionRead balance(Float balance) {
  ...
  public UserWalletCollectionRead currency(String currency) {
  ...
  public UserWalletCollectionRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public UserWalletCollectionRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
