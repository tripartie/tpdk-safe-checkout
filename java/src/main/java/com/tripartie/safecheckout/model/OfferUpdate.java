...
public class OfferUpdate {
  ...
  public OfferUpdate publicUrl(URI publicUrl) {
  ...
  **/
  ...
  public OfferUpdate redirectUrl(URI redirectUrl) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(publicUrl, redirectUrl, title, description, unitPrice, currencyCode, shippingAllowed, handDeliveryAllowed, shippingCarriers, eanCode, canBeSoldSeparately, metadata);
  }
