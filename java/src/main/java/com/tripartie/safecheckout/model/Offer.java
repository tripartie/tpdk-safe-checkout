...
public class Offer {
  ...
  public Offer status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public Offer captcha(String captcha) {
  ...
  public Offer presetBuyer(String presetBuyer) {
  ...
  public Offer unitPrice(Float unitPrice) {
  ...
  public Offer minNegotiableUnitPrice(Float minNegotiableUnitPrice) {
  ...
  public Offer allowToNegotiateUnitPrice(Boolean allowToNegotiateUnitPrice) {
  ...
  public Offer transactions(List<String> transactions) {
    this.transactions = transactions;
    return this;
  }

  public Offer addTransactionsItem(String transactionsItem) {
  ...
  public Offer quotes(List<String> quotes) {
    this.quotes = quotes;
    return this;
  }

  public Offer addQuotesItem(String quotesItem) {
    if (this.quotes == null) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("quotes") != null && !jsonObj.get("quotes").isJsonNull() && !jsonObj.get("quotes").isJsonArray()) {
