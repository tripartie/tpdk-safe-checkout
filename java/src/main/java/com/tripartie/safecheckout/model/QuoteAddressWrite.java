...
public class QuoteAddressWrite {
  ...
  public QuoteAddressWrite() {
  }

  public QuoteAddressWrite countryCode(String countryCode) {
  ...
  public QuoteAddressWrite zipCode(String zipCode) {
  ...
  public QuoteAddressWrite cityName(String cityName) {
  ...
  public QuoteAddressWrite firstLine(String firstLine) {
  ...
  public QuoteAddressWrite secondLine(String secondLine) {
  ...
  public QuoteAddressWrite buildingName(String buildingName) {
  ...
  public QuoteAddressWrite buildingFloor(String buildingFloor) {
  ...
  public QuoteAddressWrite gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class QuoteAddressWrite {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuoteAddressWrite
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteAddressWrite.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteAddressWrite is not found in the empty JSON string", QuoteAddressWrite.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteAddressWrite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteAddressWrite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteAddressWrite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteAddressWrite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteAddressWrite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteAddressWrite.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteAddressWrite>() {
           @Override
           public void write(JsonWriter out, QuoteAddressWrite value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QuoteAddressWrite read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QuoteAddressWrite given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuoteAddressWrite
   * @throws IOException if the JSON string is invalid with respect to QuoteAddressWrite
   */
  public static QuoteAddressWrite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteAddressWrite.class);
  }

  /**
   * Convert an instance of QuoteAddressWrite to an JSON string
   *
   * @return JSON string
   */
