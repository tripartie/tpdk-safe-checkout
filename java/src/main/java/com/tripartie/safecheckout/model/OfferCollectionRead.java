...
public class OfferCollectionRead {
  ...
  public OfferCollectionRead presetBuyer(String presetBuyer) {
   ...
   */
  @javax.annotation.Nullable
  public String getPresetBuyer() {
    return presetBuyer;
  }

  public void setPresetBuyer(String presetBuyer) {
    this.presetBuyer = presetBuyer;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("presetBuyer") != null && !jsonObj.get("presetBuyer").isJsonNull()) && !jsonObj.get("presetBuyer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `presetBuyer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("presetBuyer").toString()));
      }
