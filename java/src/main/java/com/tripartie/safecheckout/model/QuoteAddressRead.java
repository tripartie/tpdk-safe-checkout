...
public class QuoteAddressRead {
  ...
  public QuoteAddressRead countryCode(String countryCode) {
  ...
  public QuoteAddressRead zipCode(String zipCode) {
  ...
  public QuoteAddressRead cityName(String cityName) {
  ...
  public QuoteAddressRead firstLine(String firstLine) {
  ...
  public QuoteAddressRead secondLine(String secondLine) {
  ...
  public QuoteAddressRead buildingName(String buildingName) {
  ...
  public QuoteAddressRead buildingFloor(String buildingFloor) {
  ...
  public QuoteAddressRead gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class QuoteAddressRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuoteAddressRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteAddressRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteAddressRead is not found in the empty JSON string", QuoteAddressRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteAddressRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteAddressRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteAddressRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteAddressRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteAddressRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteAddressRead.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteAddressRead>() {
           @Override
           public void write(JsonWriter out, QuoteAddressRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QuoteAddressRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QuoteAddressRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuoteAddressRead
   * @throws IOException if the JSON string is invalid with respect to QuoteAddressRead
   */
  public static QuoteAddressRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteAddressRead.class);
  }

  /**
   * Convert an instance of QuoteAddressRead to an JSON string
   *
   * @return JSON string
   */
