...
public class OfferWrite {
  ...
  public OfferWrite nature(NatureEnum nature) {
    this.nature = nature;
    return this;
  }
  ...
  public OfferWrite unitPrice(Float unitPrice) {
  ...
  public OfferWrite minNegotiableUnitPrice(Float minNegotiableUnitPrice) {
  ...
  public OfferWrite allowToNegotiateUnitPrice(Boolean allowToNegotiateUnitPrice) {
