...
public class UserWalletAuthenticatedRead {
  ...
  public UserWalletAuthenticatedRead balance(Float balance) {
  ...
  public UserWalletAuthenticatedRead currency(String currency) {
  ...
  public UserWalletAuthenticatedRead providerName(String providerName) {
  ...
  public UserWalletAuthenticatedRead providerCreatedAt(OffsetDateTime providerCreatedAt) {
  ...
  public UserWalletAuthenticatedRead providerUpdatedAt(OffsetDateTime providerUpdatedAt) {
