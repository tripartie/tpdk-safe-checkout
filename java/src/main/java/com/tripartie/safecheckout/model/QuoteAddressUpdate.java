...
public class QuoteAddressUpdate {
  ...
  public QuoteAddressUpdate() {
  }

  public QuoteAddressUpdate countryCode(String countryCode) {
  ...
  public QuoteAddressUpdate zipCode(String zipCode) {
  ...
  public QuoteAddressUpdate cityName(String cityName) {
  ...
  public QuoteAddressUpdate firstLine(String firstLine) {
  ...
  public QuoteAddressUpdate secondLine(String secondLine) {
  ...
  public QuoteAddressUpdate buildingName(String buildingName) {
  ...
  public QuoteAddressUpdate buildingFloor(String buildingFloor) {
  ...
  public QuoteAddressUpdate gateOrPortalOrInboxCode(String gateOrPortalOrInboxCode) {
  ...
  public String toString() {
    ...
    sb.append("class QuoteAddressUpdate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QuoteAddressUpdate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QuoteAddressUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QuoteAddressUpdate is not found in the empty JSON string", QuoteAddressUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QuoteAddressUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QuoteAddressUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QuoteAddressUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QuoteAddressUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QuoteAddressUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QuoteAddressUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<QuoteAddressUpdate>() {
           @Override
           public void write(JsonWriter out, QuoteAddressUpdate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QuoteAddressUpdate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QuoteAddressUpdate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QuoteAddressUpdate
   * @throws IOException if the JSON string is invalid with respect to QuoteAddressUpdate
   */
  public static QuoteAddressUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QuoteAddressUpdate.class);
  }

  /**
   * Convert an instance of QuoteAddressUpdate to an JSON string
   *
   * @return JSON string
   */
