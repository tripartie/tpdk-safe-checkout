...
public class TransactionQuoteCollectionRead {
  ...
  private Object thirdPartyRecipientAddress;
  ...
  public TransactionQuoteCollectionRead() {
  }
  ...
  public TransactionQuoteCollectionRead ulid(String ulid) {
    this.ulid = ulid;
    return this;
  }
  ...
  public TransactionQuoteCollectionRead shippingCarrier(ShippingCarrierEnum shippingCarrier) {
  ...
  public TransactionQuoteCollectionRead pickupCode(String pickupCode) {
  ...
  public TransactionQuoteCollectionRead quantityToBeAcquired(Integer quantityToBeAcquired) {
  ...
  public TransactionQuoteCollectionRead attemptUnitPrice(Float attemptUnitPrice) {
  ...
  public TransactionQuoteCollectionRead currency(String currency) {
  ...
  public TransactionQuoteCollectionRead originalUnitPrice(Float originalUnitPrice) {
  ...
  public TransactionQuoteCollectionRead originalUnitPriceUnconverted(Float originalUnitPriceUnconverted) {
  ...
  public TransactionQuoteCollectionRead transactionFees(Float transactionFees) {
  ...
  public TransactionQuoteCollectionRead shippingFees(Float shippingFees) {
  ...
  public TransactionQuoteCollectionRead thirdPartyRecipientFirstName(String thirdPartyRecipientFirstName) {
  ...
  public TransactionQuoteCollectionRead thirdPartyRecipientLastName(String thirdPartyRecipientLastName) {
  ...
  public TransactionQuoteCollectionRead thirdPartyRecipientAddress(Object thirdPartyRecipientAddress) {
   ...
   */
  @javax.annotation.Nullable
  public Object getThirdPartyRecipientAddress() {
    return thirdPartyRecipientAddress;
  }

  public void setThirdPartyRecipientAddress(Object thirdPartyRecipientAddress) {
    this.thirdPartyRecipientAddress = thirdPartyRecipientAddress;
  }


  public TransactionQuoteCollectionRead createdAt(OffsetDateTime createdAt) {
  ...
  public TransactionQuoteCollectionRead expireAt(OffsetDateTime expireAt) {
  ...
  public String toString() {
    ...
    sb.append("class TransactionQuoteCollectionRead {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransactionQuoteCollectionRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransactionQuoteCollectionRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransactionQuoteCollectionRead is not found in the empty JSON string", TransactionQuoteCollectionRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransactionQuoteCollectionRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransactionQuoteCollectionRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TransactionQuoteCollectionRead.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransactionQuoteCollectionRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransactionQuoteCollectionRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransactionQuoteCollectionRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransactionQuoteCollectionRead.class));

       return (TypeAdapter<T>) new TypeAdapter<TransactionQuoteCollectionRead>() {
           @Override
           public void write(JsonWriter out, TransactionQuoteCollectionRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransactionQuoteCollectionRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransactionQuoteCollectionRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransactionQuoteCollectionRead
   * @throws IOException if the JSON string is invalid with respect to TransactionQuoteCollectionRead
   */
  public static TransactionQuoteCollectionRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransactionQuoteCollectionRead.class);
  }

  /**
   * Convert an instance of TransactionQuoteCollectionRead to an JSON string
   *
   * @return JSON string
   */
