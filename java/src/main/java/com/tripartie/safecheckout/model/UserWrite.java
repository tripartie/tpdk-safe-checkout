...
public class UserWrite {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(captcha, firstName, lastName, publicName, roleInCompany, birthday, email, plainPassword, intlPhoneNumber, originCountry, preferredLanguage, consentMailAds);
  }
