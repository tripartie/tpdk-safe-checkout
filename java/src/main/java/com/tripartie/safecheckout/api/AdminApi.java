...
public class AdminApi {
    ...
    private okhttp3.Call statisticsPostCall(StatisticWrite statisticWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call statisticsPostValidateBeforeCall(StatisticWrite statisticWrite, final ApiCallback _callback) throws ApiException {
        return statisticsPostCall(statisticWrite, _callback);

    }


    private ApiResponse<StatisticRead> statisticsPostWithHttpInfo(StatisticWrite statisticWrite) throws ApiException {
        okhttp3.Call localVarCall = statisticsPostValidateBeforeCall(statisticWrite, null);
        Type localVarReturnType = new TypeToken<StatisticRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call statisticsPostAsync(StatisticWrite statisticWrite, final ApiCallback<StatisticRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = statisticsPostValidateBeforeCall(statisticWrite, _callback);
        Type localVarReturnType = new TypeToken<StatisticRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIstatisticsPostRequest {
        private StatisticWrite statisticWrite;

        private APIstatisticsPostRequest() {
        }

        /**
         * Set statisticWrite
         * @param statisticWrite  (optional)
         * @return APIstatisticsPostRequest
         */
        public APIstatisticsPostRequest statisticWrite(StatisticWrite statisticWrite) {
            this.statisticWrite = statisticWrite;
            return this;
        }

        /**
         * Build call for statisticsPost
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute statisticsPost request
        ...
        public StatisticRead execute() throws ApiException {
            ApiResponse<StatisticRead> localVarResp = statisticsPostWithHttpInfo(statisticWrite);
            return localVarResp.getData();
        }

        /**
         * Execute statisticsPost request with HTTP info returned
        ...
        public ApiResponse<StatisticRead> executeWithHttpInfo() throws ApiException {
            return statisticsPostWithHttpInfo(statisticWrite);
        }

        /**
         * Execute statisticsPost request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<StatisticRead> _callback) throws ApiException {
            return statisticsPostAsync(statisticWrite, _callback);
        }
    }
     ...
     */
    public APIstatisticsPostRequest statisticsPost() {
        return new APIstatisticsPostRequest();
    }
}
