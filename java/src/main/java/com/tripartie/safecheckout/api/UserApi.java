...
public class UserApi {
    ...
    private okhttp3.Call apiOffersGetCollectionValidateBeforeCall(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, String status, Boolean shippingAllowed, final ApiCallback _callback) throws ApiException {
        return apiOffersGetCollectionCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed, _callback);

    }


    private ApiResponse<List<OfferCollectionRead>> apiOffersGetCollectionWithHttpInfo(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, String status, Boolean shippingAllowed) throws ApiException {
        okhttp3.Call localVarCall = apiOffersGetCollectionValidateBeforeCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed, null);
        Type localVarReturnType = new TypeToken<List<OfferCollectionRead>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call apiOffersGetCollectionAsync(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, String status, Boolean shippingAllowed, final ApiCallback<List<OfferCollectionRead>> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiOffersGetCollectionValidateBeforeCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed, _callback);
        Type localVarReturnType = new TypeToken<List<OfferCollectionRead>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIapiOffersGetCollectionRequest {
        ...
        public List<OfferCollectionRead> execute() throws ApiException {
            ApiResponse<List<OfferCollectionRead>> localVarResp = apiOffersGetCollectionWithHttpInfo(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<List<OfferCollectionRead>> executeWithHttpInfo() throws ApiException {
            return apiOffersGetCollectionWithHttpInfo(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<OfferCollectionRead>> _callback) throws ApiException {
            return apiOffersGetCollectionAsync(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, status, shippingAllowed, _callback);
        }
    }
    ...
    private okhttp3.Call apiProofOfIdentitiesIdPatchCall(BigDecimal id, File _file, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiProofOfIdentitiesIdPatchValidateBeforeCall(BigDecimal id, File _file, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling apiProofOfIdentitiesIdPatch(Async)");
        }

        return apiProofOfIdentitiesIdPatchCall(id, _file, _callback);

    }


    private ApiResponse<ProofOfIdentityRead> apiProofOfIdentitiesIdPatchWithHttpInfo(BigDecimal id, File _file) throws ApiException {
        okhttp3.Call localVarCall = apiProofOfIdentitiesIdPatchValidateBeforeCall(id, _file, null);
        Type localVarReturnType = new TypeToken<ProofOfIdentityRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call apiProofOfIdentitiesIdPatchAsync(BigDecimal id, File _file, final ApiCallback<ProofOfIdentityRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiProofOfIdentitiesIdPatchValidateBeforeCall(id, _file, _callback);
        Type localVarReturnType = new TypeToken<ProofOfIdentityRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIapiProofOfIdentitiesIdPatchRequest {
        private final BigDecimal id;
        private File _file;

        private APIapiProofOfIdentitiesIdPatchRequest(BigDecimal id) {
            this.id = id;
        }
         ...
         * Set _file
         * @param _file  (optional)
         * @return APIapiProofOfIdentitiesIdPatchRequest
         */
        public APIapiProofOfIdentitiesIdPatchRequest _file(File _file) {
            this._file = _file;
            return this;
        }

        /**
         * Build call for apiProofOfIdentitiesIdPatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> ProofOfIdentity resource updated </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
            <tr><td> 400 </td><td> Invalid input </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
            <tr><td> 422 </td><td> Unprocessable entity </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
            <tr><td> 404 </td><td> Resource not found </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
            <tr><td> 401 </td><td> Authentication required </td><td>  -  </td></tr>
        ...
        /**
         * Execute apiProofOfIdentitiesIdPatch request
         * @return ProofOfIdentityRead
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ProofOfIdentityRead execute() throws ApiException {
            ApiResponse<ProofOfIdentityRead> localVarResp = apiProofOfIdentitiesIdPatchWithHttpInfo(id, _file);
            return localVarResp.getData();
        }

        /**
         * Execute apiProofOfIdentitiesIdPatch request with HTTP info returned
         * @return ApiResponse&lt;ProofOfIdentityRead&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ProofOfIdentityRead> executeWithHttpInfo() throws ApiException {
            return apiProofOfIdentitiesIdPatchWithHttpInfo(id, _file);
        }

        /**
         * Execute apiProofOfIdentitiesIdPatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ProofOfIdentityRead> _callback) throws ApiException {
            return apiProofOfIdentitiesIdPatchAsync(id, _file, _callback);
        }
    }
     ...
     */
    public APIapiProofOfIdentitiesIdPatchRequest apiProofOfIdentitiesIdPatch(BigDecimal id) {
        return new APIapiProofOfIdentitiesIdPatchRequest(id);
    }
    ...
    private okhttp3.Call apiUsersIdoffersPostCall(Integer id, String ulid, OfferWrite offerWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiUsersIdoffersPostValidateBeforeCall(Integer id, String ulid, OfferWrite offerWrite, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        // verify the required parameter 'ulid' is set
        if (ulid == null) {
            throw new ApiException("Missing the required parameter 'ulid' when calling apiUsersIdoffersPost(Async)");
        }

        // verify the required parameter 'offerWrite' is set
        if (offerWrite == null) {
            throw new ApiException("Missing the required parameter 'offerWrite' when calling apiUsersIdoffersPost(Async)");
        }

        return apiUsersIdoffersPostCall(id, ulid, offerWrite, _callback);

    }


    private ApiResponse<OfferPostCreationRead> apiUsersIdoffersPostWithHttpInfo(Integer id, String ulid, OfferWrite offerWrite) throws ApiException {
        okhttp3.Call localVarCall = apiUsersIdoffersPostValidateBeforeCall(id, ulid, offerWrite, null);
        Type localVarReturnType = new TypeToken<OfferPostCreationRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call apiUsersIdoffersPostAsync(Integer id, String ulid, OfferWrite offerWrite, final ApiCallback<OfferPostCreationRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiUsersIdoffersPostValidateBeforeCall(id, ulid, offerWrite, _callback);
        Type localVarReturnType = new TypeToken<OfferPostCreationRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIapiUsersIdoffersPostRequest {
        ...
        private APIapiUsersIdoffersPostRequest(Integer id, String ulid, OfferWrite offerWrite) {
            this.id = id;
            this.ulid = ulid;
         ...
         */
        public OfferPostCreationRead execute() throws ApiException {
            ApiResponse<OfferPostCreationRead> localVarResp = apiUsersIdoffersPostWithHttpInfo(id, ulid, offerWrite);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<OfferPostCreationRead> executeWithHttpInfo() throws ApiException {
            return apiUsersIdoffersPostWithHttpInfo(id, ulid, offerWrite);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OfferPostCreationRead> _callback) throws ApiException {
            return apiUsersIdoffersPostAsync(id, ulid, offerWrite, _callback);
        }
    }
     ...
     */
    public APIapiUsersIdoffersPostRequest apiUsersIdoffersPost(Integer id, String ulid, OfferWrite offerWrite) {
        return new APIapiUsersIdoffersPostRequest(id, ulid, offerWrite);
    }
