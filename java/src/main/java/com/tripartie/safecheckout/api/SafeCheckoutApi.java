...
public class SafeCheckoutApi {
    ...
    private okhttp3.Call apiUsersIdoffersPostCall(Integer id, String ulid, OfferSoloWrite offerSoloWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiUsersIdoffersPostValidateBeforeCall(Integer id, String ulid, OfferSoloWrite offerSoloWrite, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
        ...
        return apiUsersIdoffersPostCall(id, ulid, offerSoloWrite, _callback);

    }


    private ApiResponse<OfferPostCreationRead> apiUsersIdoffersPostWithHttpInfo(Integer id, String ulid, OfferSoloWrite offerSoloWrite) throws ApiException {
        okhttp3.Call localVarCall = apiUsersIdoffersPostValidateBeforeCall(id, ulid, offerSoloWrite, null);
        Type localVarReturnType = new TypeToken<OfferPostCreationRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call apiUsersIdoffersPostAsync(Integer id, String ulid, OfferSoloWrite offerSoloWrite, final ApiCallback<OfferPostCreationRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiUsersIdoffersPostValidateBeforeCall(id, ulid, offerSoloWrite, _callback);
        Type localVarReturnType = new TypeToken<OfferPostCreationRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIapiUsersIdoffersPostRequest {
        ...
        private APIapiUsersIdoffersPostRequest(Integer id, String ulid, OfferSoloWrite offerSoloWrite) {
            this.id = id;
            this.ulid = ulid;
         ...
         */
        public OfferPostCreationRead execute() throws ApiException {
            ApiResponse<OfferPostCreationRead> localVarResp = apiUsersIdoffersPostWithHttpInfo(id, ulid, offerSoloWrite);
            return localVarResp.getData();
        }
         ...
         */
        public ApiResponse<OfferPostCreationRead> executeWithHttpInfo() throws ApiException {
            return apiUsersIdoffersPostWithHttpInfo(id, ulid, offerSoloWrite);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<OfferPostCreationRead> _callback) throws ApiException {
            return apiUsersIdoffersPostAsync(id, ulid, offerSoloWrite, _callback);
        }
    }
     ...
     */
    public APIapiUsersIdoffersPostRequest apiUsersIdoffersPost(Integer id, String ulid, OfferSoloWrite offerSoloWrite) {
        return new APIapiUsersIdoffersPostRequest(id, ulid, offerSoloWrite);
    }
}
