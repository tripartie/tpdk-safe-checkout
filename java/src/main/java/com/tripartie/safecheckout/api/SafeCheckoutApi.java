...
import com.tripartie.safecheckout.model.EvaluationRead;
import com.tripartie.safecheckout.model.EvaluationWrite;
import java.io.File;
...
import com.tripartie.safecheckout.model.ParcelWrite;
...
public class SafeCheckoutApi {
    ...
    private okhttp3.Call apiOffersGetCollectionValidateBeforeCall(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, Boolean shippingAllowed, final ApiCallback _callback) throws ApiException {
        return apiOffersGetCollectionCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed, _callback);
    ...
    private ApiResponse<List<OfferCollectionRead>> apiOffersGetCollectionWithHttpInfo(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, Boolean shippingAllowed) throws ApiException {
        okhttp3.Call localVarCall = apiOffersGetCollectionValidateBeforeCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed, null);
    ...
    private okhttp3.Call apiOffersGetCollectionAsync(Integer page, String title, String publicUrl, List<String> publicUrl2, String unitPrice, List<String> unitPrice2, Integer itemCount, List<Integer> itemCount2, String createdAtBefore, String createdAtStrictlyBefore, String createdAtAfter, String createdAtStrictlyAfter, List<String> metadata, List<String> offerMetadata, List<String> sellerMetadata, String nature, String condition, Boolean shippingAllowed, final ApiCallback<List<OfferCollectionRead>> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = apiOffersGetCollectionValidateBeforeCall(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed, _callback);
        Type localVarReturnType = new TypeToken<List<OfferCollectionRead>>(){}.getType();
    ...
    public class APIapiOffersGetCollectionRequest {
        ...
        public List<OfferCollectionRead> execute() throws ApiException {
            ApiResponse<List<OfferCollectionRead>> localVarResp = apiOffersGetCollectionWithHttpInfo(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed);
        ...
        public ApiResponse<List<OfferCollectionRead>> executeWithHttpInfo() throws ApiException {
            return apiOffersGetCollectionWithHttpInfo(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<OfferCollectionRead>> _callback) throws ApiException {
            return apiOffersGetCollectionAsync(page, title, publicUrl, publicUrl2, unitPrice, unitPrice2, itemCount, itemCount2, createdAtBefore, createdAtStrictlyBefore, createdAtAfter, createdAtStrictlyAfter, metadata, offerMetadata, sellerMetadata, nature, condition, shippingAllowed, _callback);
        }
    }
    ...
    private okhttp3.Call apiTransactionsUlidevaluationsPostCall(String ulid, EvaluationWrite evaluationWrite, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/transactions/{ulid}/evaluations"
            .replace("{" + "ulid" + "}", localVarApiClient.escapeString(ulid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call apiTransactionsUlidevaluationsPostValidateBeforeCall(String ulid, EvaluationWrite evaluationWrite, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'ulid' is set
        if (ulid == null) {
            throw new ApiException("Missing the required parameter 'ulid' when calling apiTransactionsUlidevaluationsPost(Async)");
        }

        // verify the required parameter 'evaluationWrite' is set
        if (evaluationWrite == null) {
            throw new ApiException("Missing the required parameter 'evaluationWrite' when calling apiTransactionsUlidevaluationsPost(Async)");
        }

        return apiTransactionsUlidevaluationsPostCall(ulid, evaluationWrite, _callback);

    }


    private ApiResponse<EvaluationRead> apiTransactionsUlidevaluationsPostWithHttpInfo(String ulid, EvaluationWrite evaluationWrite) throws ApiException {
        okhttp3.Call localVarCall = apiTransactionsUlidevaluationsPostValidateBeforeCall(ulid, evaluationWrite, null);
        Type localVarReturnType = new TypeToken<EvaluationRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call apiTransactionsUlidevaluationsPostAsync(String ulid, EvaluationWrite evaluationWrite, final ApiCallback<EvaluationRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = apiTransactionsUlidevaluationsPostValidateBeforeCall(ulid, evaluationWrite, _callback);
        Type localVarReturnType = new TypeToken<EvaluationRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIapiTransactionsUlidevaluationsPostRequest {
        private final String ulid;
        private final EvaluationWrite evaluationWrite;

        private APIapiTransactionsUlidevaluationsPostRequest(String ulid, EvaluationWrite evaluationWrite) {
            this.ulid = ulid;
            this.evaluationWrite = evaluationWrite;
        }

        /**
         * Build call for apiTransactionsUlidevaluationsPost
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute apiTransactionsUlidevaluationsPost request
        ...
        public EvaluationRead execute() throws ApiException {
            ApiResponse<EvaluationRead> localVarResp = apiTransactionsUlidevaluationsPostWithHttpInfo(ulid, evaluationWrite);
            return localVarResp.getData();
        }

        /**
         * Execute apiTransactionsUlidevaluationsPost request with HTTP info returned
        ...
        public ApiResponse<EvaluationRead> executeWithHttpInfo() throws ApiException {
            return apiTransactionsUlidevaluationsPostWithHttpInfo(ulid, evaluationWrite);
        }

        /**
         * Execute apiTransactionsUlidevaluationsPost request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EvaluationRead> _callback) throws ApiException {
            return apiTransactionsUlidevaluationsPostAsync(ulid, evaluationWrite, _callback);
        }
    }
     ...
     * @return APIapiTransactionsUlidevaluationsPostRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Evaluation resource created </td><td>  * X-Rate-Limit - HTTP standardized header for rate limit consumption status <br>  </td></tr>
     ...
     */
    public APIapiTransactionsUlidevaluationsPostRequest apiTransactionsUlidevaluationsPost(String ulid, EvaluationWrite evaluationWrite) {
        return new APIapiTransactionsUlidevaluationsPostRequest(ulid, evaluationWrite);
    }
