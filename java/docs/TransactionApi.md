...
<a id="apiQuotesUlidGet"></a>
# **apiQuotesUlidGet**
> QuoteRead apiQuotesUlidGet(ulid).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    TransactionApi apiInstance = new TransactionApi(defaultClient);
    String ulid = "ulid_example"; // String | Quote identifier
    try {
      QuoteRead result = apiInstance.apiQuotesUlidGet(ulid)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransactionApi#apiQuotesUlidGet");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="apiQuotesUlidPatch"></a>
# **apiQuotesUlidPatch**
> QuoteRead apiQuotesUlidPatch(ulid, quoteUpdate).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      QuoteRead result = apiInstance.apiQuotesUlidPatch(ulid, quoteUpdate)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling TransactionApi#apiQuotesUlidPatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
